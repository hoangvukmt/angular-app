...
import { AddAgencyComponent } from '../popup/add-agency/add-agency.component';
import { AddInsuranceCompanyComponent } from '../popup/add-insurance-company/add-insurance-company.component';
import { AddTextComponent } from '../popup/add-text/add-text.component';
import { AddInsuranceTypeComponent } from '../popup/add-insurance-type/add-insurance-type.component';
...
declare var $: any;
@Component({
  selector: 'app-insurance-info-edit',
  templateUrl: './insurance-info-edit.component.html',
  styleUrls: ['./insurance-info-edit.component.css']
})
export class InsuranceInfoEditComponent extends BaseCpnComponent implements OnInit, AfterViewInit {
  ...
  public headerTitle = '';
  public showErrorAgency = false;
  public numberImageRelation: number;
  public countImg: number;
  public listFamily = [];
  public listShukeiyaku = [];
  public listTokuyaku = [];
  public listImageTemp = [];
  ...
  constructor(
    ...
    super(translate, 'insurance-info-edit');
  }
  ...
  initData(): void {
    if (this.keiyakuDetail.keiyaku_no > 0) {
      this.httpService.post(this.API_URLS.getDetailKeiyaku, { keiyaku_no: this.keiyakuDetail.keiyaku_no }).subscribe(res => {
        if (res.code === this.RESULT_CODE.success) {
          let keiData = res.data;
          this.countImg = keiData.keiyakuField.countImg;

          this.keiyakuDetail.keiyaku_no = keiData.keiyakuField.KeiyakuNo;
          this.keiyakuDetail.hosho_category_f = keiData.keiyakuField.HoshoCategoryF;
          this.keiyakuDetail.group_id = keiData.keiyakuField.GroupID;
          this.keiyakuDetail.agent_no = keiData.keiyakuField.AgentNo;
          this.keiyakuDetail.agent_name = keiData.keiyakuField.AgentName;
          this.keiyakuDetail.company_cd = keiData.keiyakuField.CompanyCd;
          this.keiyakuDetail.company_name = keiData.keiyakuField.CompanyName;
          this.keiyakuDetail.tanto_name_company = keiData.keiyakuField.TantoNameCompany;
          this.keiyakuDetail.phone = keiData.keiyakuField.Phone;
          this.keiyakuDetail.url = keiData.keiyakuField.URL;
          this.keiyakuDetail.memo = keiData.keiyakuField.Memo;
          this.keiyakuDetail.product_cd = keiData.keiyakuField.ProductCd;
          this.keiyakuDetail.product_name = keiData.keiyakuField.ProductName;
          this.keiyakuDetail.category_cd = keiData.keiyakuField.CategoryCd;
          this.keiyakuDetail.policy_no = keiData.keiyakuField.PolicyNo;
          this.keiyakuDetail.status = keiData.keiyakuField.Status;
          this.keiyakuDetail.h_kikan = keiData.keiyakuField.HKikan;
          this.keiyakuDetail.h_kikan_f = keiData.keiyakuField.HKikanF;
          this.keiyakuDetail.hoken_p = keiData.keiyakuField.HokenP;
          this.keiyakuDetail.p_kikan = keiData.keiyakuField.PKikan;
          this.keiyakuDetail.p_kikan_f = keiData.keiyakuField.PKikanF;
          this.keiyakuDetail.haraikata = keiData.keiyakuField.Haraikata;
          this.keiyakuDetail.family_no = keiData.keiyakuField.FamilyNo;
          this.keiyakuDetail.family_name = keiData.keiyakuField.FamilyName;
          this.keiyakuDetail.hiho_family_no = keiData.keiyakuField.HihoFamilyNo;
          this.keiyakuDetail.hiho_family_name = keiData.keiyakuField.HihoFamilyName;
          this.keiyakuDetail.contract_date = keiData.keiyakuField.ContractDate;
          this.keiyakuDetail.hoken_end_date = keiData.keiyakuField.HokenEndDate;
          this.keiyakuDetail.nyuryoku_f = keiData.keiyakuField.NyuryokuF;
          this.keiyakuDetail.foreign_f = keiData.keiyakuField.ForeignF;
          this.keiyakuDetail.contact_accident = keiData.keiyakuField.ContactAccident;
          this.keiyakuDetail.contact_car_failure = keiData.keiyakuField.ContactCarFailure;
          this.keiyakuDetail.car_name = keiData.keiyakuField.CarName;
          this.keiyakuDetail.regist_no = keiData.keiyakuField.RegistNo;
          this.keiyakuDetail.address = keiData.keiyakuField.Address;
          this.keiyakuDetail.currency_f = keiData.keiyakuField.CurrencyF;
          this.keiyakuDetail.foreign_f_name = keiData.keiyakuField.ForeignFName;

          this.listShukeiyaku = keiData.shuKeiyaku;
          this.listTokuyaku = keiData.tokuyakus;
          if (typeof localStorage.getItem('mockDataKeiyaku') !== "undefined" && localStorage.getItem('mockDataKeiyaku') !== null) {
            this.keiyakuDetail = JSON.parse(localStorage.getItem('mockDataKeiyaku'));
            localStorage.removeItem('mockDataKeiyaku');

            this.listShukeiyaku = this.keiyakuDetail.shukeiyaku;
            this.listTokuyaku = this.keiyakuDetail.tokuyakus;

            this.mapHaraikata(this.keiyakuDetail.hosho_category_f);
          }
          else {
            this.mapHaraikata(keiData.keiyakuField.HoshoCategoryF);
          }
      ...
      this.listImageTemp = localStorage.getItem('listFileNameTemp') !== null ? JSON.parse(localStorage.getItem('listFileNameTemp')) : [];
      this.countImg = this.listImageTemp.length;
      this.keiyakuDetail.hosho_category_f = Number(localStorage.getItem('categoryID'));
      this.keiyakuDetail.group_id = this.globalsHome.group_id;
      ...
      if (typeof localStorage.getItem('mockDataKeiyaku') !== "undefined" && localStorage.getItem('mockDataKeiyaku') !== null) {
        ...
        if (this,this.fieldOfKeiyaku.Category.type !== 30) {
  ...
  goToListImg(): void {
    this.mapDataToSave();
    this.globalsHome.keiyaku_no = this.keiyakuDetail.keiyaku_no;
    this.globalsHome.family_no = this.familyNoFormControl.value;
    this.globalsHome.hiho_family_no = this.hihoFamilyNoFormControl.value;
    localStorage.setItem('pre-page-shouken-list', this.router.url);
    localStorage.setItem('mockDataKeiyaku', JSON.stringify(this.keiyakuDetail));
    this.router.navigate(['/' + this.ROUTER_URL.shoukenList + '/' + this.keiyakuDetail.group_id + '/false']);
  }

  goToListImgOther(): void {
    if (this.numberImageRelation > 0) {
      ...
      localStorage.setItem('mockDataKeiyaku', JSON.stringify(this.keiyakuDetail));
      this.router.navigate(['/' + this.ROUTER_URL.shoukenList + '/' + this.keiyakuDetail.group_id + '/relation']);
    }
  }
  ...
  choseAgency(): void {
    const dialogCommon = this.dialog.open(SelectItemCommonComponent, {
      width: '400px',
      data: { popupTitle: '代理店選択', category: 'AGENCY' },
      panelClass: ['remodal-wrapper', 'remodal-is-opened', 'custom-modal']
    });
      ...
      if (result && result.key === 'HANDLE') {
        ...
        dialogAgency.afterClosed().subscribe(resultHandle => {
          if (resultHandle) {
            ...
            if (this.keiyakuDetail.agent_no) {
              this.showErrorAgency = false;
            } else {
              this.showErrorAgency = true;
            }
          } else {
            this.showErrorAgency = true;
          }
  ...
  deleteShukeiyaku(isShukeiyaku: boolean, index: number, indexTokuyaku?: number) {
    const dialogCompany = this.dialog.open(ConfirmCommonComponent, {
      width: '300px',
      data: { title: '', content: 'この項目を削除します。よろしいですか。', btnAcceptTitle: '削除' },
      panelClass: ['remodal-wrapper', 'remodal-is-opened', 'custom-modal']
    });
    ...
    dialogCompany.afterClosed().subscribe(result => {
      if (result === 'OK') {
        ...
        this.keiyakuDetail.shukeiyaku_delete.push(this.listTokuyaku[indexTokuyaku].tokuyakuHoshos[index].KeiyakuHoshoNo);
        if (this.listTokuyaku[indexTokuyaku].tokuyakuHoshos.length === 1) {
          this.listTokuyaku[indexTokuyaku].tokuyakuHoshos = [];
        }
        else {
          for (let i = 0; i < this.listTokuyaku[indexTokuyaku].tokuyakuHoshos.length; i++) {
            if (i === index) {
              this.listTokuyaku[indexTokuyaku].tokuyakuHoshos.splice(i, 1);
              break;
            }
          }
          for (let i = 0; i < this.listTokuyaku[indexTokuyaku].tokuyakuHoshos.length; i++) {
            this.listTokuyaku[indexTokuyaku].tokuyakuHoshos[i].SeqNo = i + 1;
          }
        }
      }
    });
  ...
  goDetailHosho(isShukeiyaku: boolean, index: number, indexTokuyaku?: number): void {
    ...
    if (isShukeiyaku) {
      ...
      hosho = $.extend({}, this.listTokuyaku[indexTokuyaku].tokuyakuHoshos[index]);
    }
    if (hosho.TypeF === 60) {
    ...
    dialogText.afterClosed().subscribe(result => {
      if (result) {
        if (isShukeiyaku) {
          ...
          this.listTokuyaku[indexTokuyaku].tokuyakuHoshos[index] = result.hosho;
        }
        this.checkWindow();
      }
    });
      ...
      if (result) {
        ...
        if (isShuKeiyaku) {
          ...
          if (typeof newTokuyaku !== "undefined" && newTokuyaku !== null) {
            ...
            countList = this.listTokuyaku[index].tokuyakuHoshos.length;
          }
        }
        ...
        if (isShuKeiyaku) {
          ...
          if (typeof newTokuyaku !== "undefined" && newTokuyaku !== null) {
            if (
              ...
              result.tokuyaku.tokuyakuHoshos.push(result.hosho);
            }
            
            this.listTokuyaku.push(result.tokuyaku);
          }
          else {
            this.listTokuyaku[index].tokuyakuHoshos.push(result.hosho);
          }
        }
        this.checkWindow();
      }
    ...
    if (isShukeiyaku) {
      ...
      if (this.listTokuyaku[indexTokuyaku].tokuyakuHoshos[index].TypeF === 10) {
        if (!isNaN(this.listTokuyaku[indexTokuyaku].tokuyakuHoshos[index].ColumnVal) && this.listTokuyaku[indexTokuyaku].tokuyakuHoshos[index].HoshoNo !== 0 && this.listTokuyaku[indexTokuyaku].tokuyakuHoshos[index].HoshoNo !== '0') {
          return this.listTokuyaku[indexTokuyaku].tokuyakuHoshos[index].ColumnVal.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ',') + this.keiyakuDetail.foreign_f_name;
        } else {
          return this.listTokuyaku[indexTokuyaku].tokuyakuHoshos[index].ColumnVal;
        }
      }
      else if (this.listTokuyaku[indexTokuyaku].tokuyakuHoshos[index].TypeF === 100) {
        if (!isNaN(this.listTokuyaku[indexTokuyaku].tokuyakuHoshos[index].ColumnVal) && this.listTokuyaku[indexTokuyaku].tokuyakuHoshos[index].HoshoNo !== 0 && this.listTokuyaku[indexTokuyaku].tokuyakuHoshos[index].HoshoNo !== '0') {
          return this.listTokuyaku[indexTokuyaku].tokuyakuHoshos[index].ColumnVal.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ',');
        } else {
          return this.listTokuyaku[indexTokuyaku].tokuyakuHoshos[index].ColumnVal;
        }
      }
  ...
  doBack(): void {
    const dialogCompany = this.dialog.open(ConfirmCommonComponent, {
      width: '300px',
      data: { title: '', content: '編集を破棄しますか？', btnAcceptTitle: '破棄' },
      panelClass: ['remodal-wrapper', 'remodal-is-opened', 'custom-modal', 'confirm-modal']
    });

    dialogCompany.afterClosed().subscribe(result => {
      if (result === 'OK') {
        this.router.navigate([localStorage.getItem('page-goto-edit')]);
      }
    });
  }

  doSave(): void {
    if (this.checkTypeOfField()) {
      this.mapDataToSave();
      if (typeof this.keiyakuDetail.keiyaku_no === "undefined" || this.keiyakuDetail.keiyaku_no === null || this.keiyakuDetail.keiyaku_no <= 0) {
        this.callApiCreateKeiyaku();
      }
      else {
        this.callApiUpdateDetailKeiyaku();
      }
    }
  }
  ...
  callApiCreateKeiyaku() {
    delete this.keiyakuDetail.keiyaku_no;
    this.keiyakuDetail.nyuryoku_f = 1;
    this.keiyakuDetail.file_uploads = this.listImageTemp;

    this.httpService.post(this.API_URLS.createKeiyaku, this.keiyakuDetail).subscribe(res => {
      if (res.code === this.RESULT_CODE.success) {
        ...
        if (res.data.GroupId !== 0) {
          ...
          this.httpService.post(this.API_URLS.updateAuto, formData).subscribe(resGroup => {
            if (resGroup.code === this.RESULT_CODE.success) {
              this.router.navigate(['/' + this.ROUTER_URL.insuranceInfo + '/' + res.data.KeiyakuId]);
            } else {
  ...
  callApiUpdateDetailKeiyaku() {
    this.httpService.post(this.API_URLS.updateKeiyaku, this.keiyakuDetail).subscribe(res => {
      if (res.code === this.RESULT_CODE.success) {
        this.router.navigate(['/' + this.ROUTER_URL.insuranceInfo + '/' + this.keiyakuDetail.keiyaku_no]);
      } else {
        this.requestResult.err = true;
        this.requestResult.msg = res.message;
        const dialogText = this.dialog.open(AddTextComponent, {
  ...
  mapHaraikata(HoshoCategoryF: any) {
    ...
    this.httpService.post(this.API_URLS.getFamily, { login_id: localStorage.getItem('login_id') }).subscribe(res => {
      if (res.code === this.RESULT_CODE.success) {
        res.data.forEach(person => {
          ...
          if ((this.keiyakuDetail.hiho_family_name === null || this.keiyakuDetail.hiho_family_name === '') && localStorage.getItem('familyNo') === person.FamilyNo.toString()) {
            if (this.fieldOfKeiyaku.HihoFamilyNo.type === 40) {
              this.hihoFamilyNoFormControl.setValue(person.FamilyNo.toString());
            }
          }
        });
      } else {
